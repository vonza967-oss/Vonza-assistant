...
- Non-launch request-desk product shells are pruned from the launch runtime. Package metadata should not expose public routes, dashboard selectors, widget/embed behavior, provider execution, operations cockpit behavior, or quote pricing behavior unless a later scoped product decision reintroduces those surfaces.

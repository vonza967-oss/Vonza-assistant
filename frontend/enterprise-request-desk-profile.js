  ...
  const profiles = Object.freeze({
    ...
    esg: Object.freeze({
      ...
      dashboard: {
        ...
        heading: "ESG megkereséslista",
        intro: "Queue, brief, hiányzó adat, státusz.",
        sideTitle: "Kontrollált pilot",
        sideBody: "Belső átadás. Nincs ár vagy garancia.",
        setupActive: "ESG pult aktív",
        safetyTitle: "Belső feldolgozás",
        safetyBody: "Rövid ESG munkanézet.",
        emptyQueue: "Még nincs beérkezett ESG megkeresés.",
        emptyHint: "Nyissa meg az ESG intake linket.",
        workspaceLabels: {
          overview: "Áttekintés",
          requests: "Megkeresések",
          security_guarding: "Őrzés-védelem",
          reception_object_protection: "Porta / objektum",
          facility_management: "Facility Management",
          security_technology: "Biztonságtech.",
          audit_compliance: "Audit",
          mixed_enterprise_request: "Vegyes",
          settings: "Beállítások",
        },
        workspaceDescriptions: {
          overview: "Queue állapot.",
          requests: "Minden ESG ügy.",
          security_guarding: "Őrzés-védelem.",
          reception_object_protection: "Porta, recepció, beléptetés.",
          facility_management: "FM és karbantartás.",
          security_technology: "Kamera, beléptetés, riasztó.",
          audit_compliance: "Hatósági, audit, beszerzés.",
          mixed_enterprise_request: "Több lane bontása.",
          settings: "Setup, linkek, határok.",
        },
        workspaceEmptyStates: {
          security_guarding: "Nincs őrzés-védelmi ügy.",
          reception_object_protection: "Nincs porta / objektum ügy.",
          facility_management: "Nincs FM ügy.",
          security_technology: "Nincs biztonságtechnikai ügy.",
          audit_compliance: "Nincs audit ügy.",
          mixed_enterprise_request: "Nincs vegyes ügy.",
        },
      },
      setup: {

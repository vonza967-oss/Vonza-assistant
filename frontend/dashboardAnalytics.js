(function registerVonzaDashboardAnalytics(global) {
  ...
  const SOURCE_DESCRIPTIONS = Object.freeze({
    widget: "Customer conversations started from the Website Agent.",
  ...
  const TEXT_FALLBACKS = Object.freeze({
    ...
    "analytics.waitingForTrafficCopy": "After customers use the hosted Front Desk page, QR/direct link, embed, or Website Agent, performance signals will appear here.",

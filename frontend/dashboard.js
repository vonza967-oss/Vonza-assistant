...
const DASHBOARD_HU_PHRASES = Object.freeze({
  ...
  "Web Call Front Desk": "Webes Front Desk hívás",
  "Ready on the hosted Front Desk page.": "Kész a hosztolt Front Desk oldalon.",
  "Enable Web Call Front Desk last.": "Végül engedélyezd a Webes Front Desk hívást.",
  "Test the browser voice path before sharing Web Call publicly.": "Teszteld a böngészős hangútvonalat, mielőtt nyilvánosan megosztod a webes hívást.",

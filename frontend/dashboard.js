...
const DASHBOARD_HU_PHRASES = Object.freeze({
  ...
  "Front Desk page, QR/direct link, smart embed, WordPress, or optional bubble is ready": "Front Desk oldal, QR/direkt link, okos beágyazás, WordPress vagy opcionális buborék készen áll",
  "Choose a launch channel in Install": "Válassz élesítési csatornát a Telepítésben",
  "Setup progress": "Beállítási állapot",
  "Choose method": "Módszer kiválasztása",
  "Pick Front Desk page, QR/direct link, or optional bubble.": "Válassz Front Desk oldalt, QR/direkt linket vagy opcionális buborékot.",
  "Configure": "Beállítás",
  "Use the ready code or link.": "Használd a kész kódot vagy linket.",
  "Verify": "Ellenőrzés",
  "Confirm any website embed or bubble install.": "Ellenőrizd a weboldali beágyazást vagy buboréktelepítést.",
  "Share the working entry point.": "Oszd meg a működő belépési pontot.",
  ...
  "Choose how customers should open the AI Front Desk page. Vonza generates the right link, WordPress guidance, smart embed, or fallback iframe.": "Válaszd ki, hogyan nyissák meg az ügyfelek az AI Front Desk oldalt. A Vonza elkészíti a megfelelő linket, WordPress útmutatót, okos beágyazást vagy tartalék iframe-et.",
  ...
  "Use a QR code or direct link that opens the full-page Front Desk page.": "Használj QR-kódot vagy direkt linket, amely megnyitja a teljes oldalas Front Desk oldalt.",

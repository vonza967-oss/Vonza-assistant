(function registerVonzaDashboardI18n(global) {
  ...
  const translations = {
    ...
    hu: {
      ...
      "analytics.fullPageActivity": "Teljes oldalas aktivitás",
      ...
      "analytics.fullPageConversationsRecorded": "Rögzített teljes oldalas beszélgetések",
      ...
      "settings.copy": "Az asszisztens arculat, vállalkozási kontextus, számlázás, adatvédelem és workspace-hozzáférés kezelése.",
      "settings.theme": "Téma",

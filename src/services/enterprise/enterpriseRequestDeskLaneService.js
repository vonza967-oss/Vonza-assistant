...
const LANE_DEFINITION_INPUTS = [
  ...
  },
  {
    ...
    covers: [
      ...
      "Takarítási, karbantartási, üzemeltetési vagy helyszíni szolgáltatási mix előminősítése.",
    ],
    keywords: [
      "facility management",
      "fm",
  ...
  },
  {
    ...
    labelHu: "Audit / compliance",
    covers: [
      "Vagyonvédelmi, biztonsági, üzemeltetési vagy megfelelőségi audit előkészítése.",
      "Szabályzat, kockázatértékelés, megfelelőségi anyag vagy belső ellenőrzési igény első tisztázása.",
    ...
    keyQualifyingQuestions: [
      "Milyen audit vagy megfelelőségi célhoz kell előkészítés?",
      "Mely terület érintett: őrzés-védelem, FM, biztonságtechnika vagy belső szabályozás?",
      "Van határidő, auditdátum vagy konkrét dokumentumlista, amit figyelembe kell venni?",
    ],
  },
  {

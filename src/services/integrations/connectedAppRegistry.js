...
const CONNECTED_APP_CAPABILITY_INPUTS = Object.freeze([
  ...
  },
  {
    ...
    description:
      "Manual/status-only WhatsApp Business capability for inbound webhook verification readiness. Phase 11 verifies Meta setup and records safe webhook status only; it does not process inbound messages.",
    status: "planned",
    ownerScoped: true,
    agentScoped: true,
    requiresOAuth: false,
    ...
    allowedSurfaces: Object.freeze(["webhook", "dashboard", "internal"]),
    proofSources: Object.freeze([
      "Meta webhook verification uses hub.mode, hub.verify_token, and hub.challenge against a derived verifier stored outside public metadata.",
    ...
    safetyNotes: Object.freeze([
      ...
      "No WhatsApp messages are processed or sent by this capability.",
      "The webhook route records verification/readiness metadata only.",
      "No Meta OAuth, Embedded Signup, Cloud API client, or Twilio WhatsApp path exists yet.",

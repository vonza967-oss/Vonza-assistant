  ...
  await withEnv(
    {
      ...
      VONZA_MAC_DMG_URL: undefined,
      VONZA_MAC_DMG_SHA256: undefined,
      VONZA_MAC_DMG_SIGNED_NOTARIZED: undefined,
      VONZA_MAC_VERSION: undefined,
      VONZA_MAC_RELEASE_DATE: undefined,
    },
    async () => {
      ...
      try {
        ...
        await withEnv({
          ...
          VONZA_MAC_DMG_SHA256: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
  ...
  await withEnv(
    ...
    async () => {
      ...
      try {
        ...
        assert.match(dashboardTodayScript.text, /Home at a glance/);
        assert.match(dashboardTodayScript.text, /Messages today/);
        assert.match(dashboardScript.text, /Your AI customer service snapshot for today/);
        assert.match(dashboardTodayScript.text, /Approval-first proposals/);
        assert.match(dashboardTodayScript.text, /What to improve next/);
        assert.match(dashboardTodayScript.text, /These are the changes most likely to improve customer satisfaction and save time/);
        assert.match(dashboardTodayScript.text, /Show supporting detail/);
        assert.match(`${dashboardScript.text}\n${dashboardTodayScript.text}`, /AI priorities|Home|Queue/);
        assert.match(dashboardScript.text, /Recent wins/);
        assert.match(dashboardScript.text, /Improve service/);
        assert.match(dashboardTodayScript.text, /today-queue-row/);
        assert.match(dashboardTodayScript.text, /data-today-open-review/);

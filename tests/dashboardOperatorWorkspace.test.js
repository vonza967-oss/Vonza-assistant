...
test("install section stays focused on install methods and verification", () => {
  ...
  assert.match(pagePanel, /Place the assistant inside part of an existing website page\./);
  assert.match(pagePanel, /Full-page iframe/);
  assert.match(pagePanel, /Make a dedicated page on your own website become the assistant page\./);

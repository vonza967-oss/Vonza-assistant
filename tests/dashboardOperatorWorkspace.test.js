...
test("install section stays focused on install methods and verification", () => {
  ...
  assert.match(pagePanel, /Full-page embed/);
  assert.match(pagePanel, /Use this when the assistant is the main content of a dedicated page on your website\./);
  ...
  assert.match(pagePanel, /id="full-page-option-embed" role="tabpanel" data-full-page-option-panel="embed" hidden/);
